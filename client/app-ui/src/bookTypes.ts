...
export const BOOK_TYPES: BookTypeConfig[] = [
  ...
  { id: 'thought_leadership', displayName: 'Business Thought Leadership', description: 'POV content for business leaders.', defaultMode: 'expert', allowedModes: ['expert', 'classical'], defaultSkill: 'general_book_page', sourcePolicy: 'recommended', defaultFormat: 'modern-editorial', defaultTone: 'insightful and practical' },
  ...
  { id: 'educational_how_to', displayName: 'Educational / How-To Book', description: 'Instructional and learning-focused.', defaultMode: 'classical', allowedModes: ['classical', 'expert'], defaultSkill: 'general_book_page', sourcePolicy: 'optional', defaultFormat: 'classic-novel', defaultTone: 'clear and instructive' },
  { id: 'custom', displayName: 'Custom', description: 'Custom objective and tone.', defaultMode: 'classical', allowedModes: ['classical', 'expert'], defaultSkill: 'general_book_page', sourcePolicy: 'optional', defaultFormat: 'classic-novel', defaultTone: 'balanced' },
]
